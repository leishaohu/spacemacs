...
values."
  (setq-default
   ...
   '(
     ;; ------------------------------------Cannot find any of the specified fonts (Source Code Pro)! ----------------------------
     ;; Example of useful layers you may want to use right away.
     ;; Uncomment some layer names and press <n layer --------------------------- declared in dotfile.    SPC f e R> (Vim style) or
...
`dotspacemacs/user-config' first."
  ...
  (setenv "HOME" "d:/linux/emacs")
  (setenv "PATH" "d:/linux/emacs")
